// Discourse's Message Bus library, retro fitted for ES6
import MessageBusAjax from './message-bus-ajax';
var previousMessageBus = window.MessageBus;
...
longPoller = function(poll,data){
  ...
  var req = me.ajax({
    ...
    xhr: function() {
      var xhr = MessageBusAjax.ajaxSettings.xhr();
      if (!chunked) {
        return xhr;
      }
...
me = {
  ...
  ajax: MessageBusAjax,
  noConflict: function(){
    window.MessageBus = window.MessageBus.previousMessageBus;
    return this;
  },
  ...
  start: function() {
    ...
    if(document.addEventListener && 'hidden' in document){
      me.visibilityEvent = window.document.addEventListener('visibilitychange', function(){
